...
<div class="container">
    ...
    <div class="frm-control">
        <div class="link-header">
            <h3><span class="color-1"><?php echo $position_name;?></span> > Cập nhật dịch vụ</h3>
        </div>
        <!--step form-->
        ...
        <div class="box-form" style="padding-top: 15px">
            <div class="box-btn-ctrl">
                <a class="save-continues btn-default btn-primary"  href="<?php echo ROOTHOST."member/".$position_code."/co-so/cap-nhat-thu-vien-anh/".$positioncontact_id;?>">Save And Continues</a>
            </div>
            <div class="row">
                <div class="col-md-6">
                    <form id="frm-addnew" name="frm-addnew" method="post" action="<?php echo $url_ajax_action;?>"  enctype="multipart/form-data">
                        ...
                        <div class="form-group clearfix">
                            ...
                            <textarea name="txt_intro" id="txt_intro" size="45" style="height: 90px"></textarea>
                        </div>
                        <div class="form-group">
