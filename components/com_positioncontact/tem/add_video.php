...
<div class="container">
    <div class="frm-control">
        <div class="link-header">
            <h3><span class="color-1"><?php echo $position_name;?></span> > Thêm video</h3>
        </div>
        ...
        <div class="box-form">
            ...
            <div class="box-btn-act top30">
                <a href="<?php echo ROOTHOST;?>member/<?php echo $position_code;?>/co-so/them-bai-viet-lien-quan/<?php echo $positioncontact_id;?>" class="save-continues btn-default btn-primary">Lưu và tiếp tục</a>
            </div>
            <h3 class="title">Thư viện video của bạn</h3>
            <div id="respon-video">
                <?php  $objPoVi->getListInfoVideo("WHERE `position_id`=".$positioncontact_id.""); ?>
            </div>
        </div>
