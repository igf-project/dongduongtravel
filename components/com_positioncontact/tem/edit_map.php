...
<div class="container">
    <div class="frm-control">
        <h3 class="head">Cập nhật thông tin > <span class="color-1"><?php echo $position_code;?></span> </h3>
        ...
        <div class="box-form">
            ...
            <div class="box-btn-act top20">
                <a href="<?php echo ROOTHOST;?>member/<?php echo $position_code;?>/co-so/cap-nhat-thu-vien-anh/<?php echo $id;?>" class="save-continues btn-default btn-primary">Continues</a>
            </div>
