...
<div class="container">
    <div class="frm-control">
        <h3 class="head"><span class="color-1"><?php echo $position_name;?></span> > Cập nhật bài viết liên quan</h3>
        <!--step form-->
        ...
        <div class="box-form">
            ...
            <div class="box-btn-act top30">
                <a href="<?php echo ROOTHOST;?>member/dia-diem/danh-sach" class="save-continues btn-default btn-primary">Hoàn thành</a>
            </div>
