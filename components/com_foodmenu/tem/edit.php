...
$row=$obj->Fetch_Assoc();
$positioncontact_name=$objPoCon->getNameByid($row['positioncontact_id']);
$food_code=$row['code'];
?>
<div class="container">
    <div class="link-header">
        <h3><span class="color-1"><?php echo $position_name;?></span><?php if($positioncontact_name!='') {echo " > ".$positioncontact_name;} echo " > ".$row['name'];?> > Cập nhật</h3>
    </div>
    <div class="frm-control">
        <h3 class="h3-header">Cập nhật thực đơn</h3>
        <div class="box-step column-4">
            <ul>
                <li class="active">
                    <span class="number num1">01</span>
                    <a href="<?php echo ROOTHOST.'member/thuc-don/cap-nhat/'.$position_id.'/'.$positioncontact_id.'/'.$id;?>" class="name">Thông tin thực đơn</a>
                </li>
                <li class="">
                    <span class="number num2">02</span>
                    <a href="<?php echo ROOTHOST.'member/thuc-don/'.$food_code.'/cap-nhat-thu-vien-anh/'.$position_id.'/'.$positioncontact_id.'/'.$id;?>" class="name">Thư viện ảnh</a>
                </li>
                <li class="">
                    <span class="number num3">03</span>
                    <a href="<?php echo ROOTHOST.'member/thuc-don/'.$food_code.'/cap-nhat-thu-vien-video/'.$position_id.'/'.$positioncontact_id.'/'.$id;?>" class="name">Thư viện video</a>
                </li>
                <li>
                    <span class="number num4">04</span>
                    <a href="<?php echo ROOTHOST.'member/thuc-don/'.$food_code.'/cap-nhat-bai-viet-lien-quan/'.$position_id.'/'.$positioncontact_id.'/'.$id;?>" class="name">Tin liên quan</a>
                </li>
            </ul>
        </div>
            ...
            <div class="row">
                ...
                <div class='form-group col-md-6'>
                    ...
                    <select name="cbo_cateid" id="cbo_cateid" class='form-control'>
                        ...
                        <?php
                        echo $obj->getListCbFoodCategory($row['cate_id']);
                        ?>
                    </select>
                </div>
                <div class='form-group col-md-6'>
                    ...
                    <select name="cbo_recomid" id="cbo_recomid" class='form-control'>
                        ...
                        <?php
                        echo $obj->getListCbFoodRecommend($row['recom_id']);
                        ?>
                    </select>
                </div>
                <div class='form-group col-md-6'>
