    ...
    <div class="frm-control">
        ...
        <div class="box-form">
            ...
            <div class="box-btn-act top20">
                <a href="<?php echo ROOTHOST."member/thuc-don/".$food_code."/them-thu-vien-video/".$position_id."/".$positioncontact_id."/".$food_id;?>" class="save-continues btn-default btn-primary">Lưu và tiếp tục</a>
            </div>
            <div id="respon-img">
