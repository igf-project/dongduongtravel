		...
		<form id="frm_action" name="frm_action" method="post" action=""  enctype="multipart/form-data">
			...
			<div class="row">
				<div class='form-group col-md-6'>
					...
					<input name="txt_fullname" type="text" id="txt_fullname" size="45" class='form-control' value="" placeholder='' />
				</div>
				<div class='form-group col-md-6'>
					<label class="control-label"><strong>Mã số CMTND </strong></label>
					<input name="txt_cmt" type="text" id="txt_cmt" size="45" class='form-control' value="" placeholder='' />
				</div>
				<div class='form-group col-md-6'>
