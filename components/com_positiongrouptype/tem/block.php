...
<?php
    ...
    $arr_group='';
    $arr_location='';
    $location_code= isset($_GET['code']) ? addslashes($_GET['code']):'';
    $positiongroup_code= isset($_GET['group']) ? addslashes($_GET['group']):'';
    if($location_code=='' || $positiongroup_code==''){
        die("PAGE NOT FOUND");
    }
    ...
    /*check type param from url*/
    if(isset($_GET['code']) AND isset($_GET['group']) AND isset($_GET['type'])){ 
        /* dạng home/location/positiongrouptype/positiontype*/
        $arr=$objPoType->getIdAndNameByCode($_GET['type']);
        $positiontype_id=$arr['id'];
        $positiontype_name=$arr['name'];
        $strWhere.=" AND `tbl_position`.`location_id`=$location_id AND `tbl_position`.`positiongrouptype_id`=$positiongrouptype_id AND `tbl_position`.`positiontype_id`=$positiontype_id";
    }
    elseif(isset($_GET['code']) AND isset($_GET['group'])){
        /* dạng home/location/positiongrouptype*/
        $strWhere.=" AND `tbl_position`.`location_id`=$location_id AND `tbl_position`.`positiongrouptype_id`=$positiongrouptype_id";
    }
    ...
    <div class="page-content">
        <div class="box-path">
            <ul class="list-inline">
                ...
                <?php if(isset($_GET['code'])):;?>> <li><a href="<?php echo ROOTHOST.$location_code;?>"><?php echo $location_name;?></a></li><?php endif;?>
                > <li><a href="<?php echo ROOTHOST.$location_code."/".$positiongroup_code;?>"><?php echo $positiongrouptype_name;?></a></li>
                <?php if(isset($_GET['type']))
                echo ' > <li><a href="#">'.$positiontype_name.'</a></li>';
                ?>
            </ul>
        </div>
