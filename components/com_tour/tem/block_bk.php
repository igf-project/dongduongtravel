...
if(isset($_GET['location_code'])){
    ...
    $url_form=ROOTHOST."tour/".$tourtype_code."/danh-sach";
}
...
if(isset($_POST['finder'])){
    ...
    if($price_rank!='0'){
        switch($price_rank){
            case "1" : $strWhere="$strWhere $strWherLo AND `tbl_tour_price`.`price` < '1000000'";
                break;
            case "2" : $strWhere="$strWhere $strWherLo AND `tbl_tour_price`.`price` BETWEEN '1000000' AND '3000000'";
                break;
            case "3" : $strWhere="$strWhere $strWherLo AND `tbl_tour_price`.`price` BETWEEN '3000000' AND '5000000'";
                break;
            case "4" : $strWhere="$strWhere $strWherLo AND `tbl_tour_price`.`price` BETWEEN '5000000' AND '7000000'";
                break;
            case "5" : $strWhere="$strWhere $strWherLo AND `tbl_tour_price`.`price` BETWEEN '7000000' AND '10000000'";
                break;
            case "5" : $strWhere="$strWhere $strWherLo AND `tbl_tour_price`.`price` BETWEEN >10000000";
                break;
            default: $strWhere='';
        }
    }
        ...
        <div class="box-title">
            ...
            <div class="box-find pull-right">
                <form class="form-inline" action="<?php echo $url_form;?>" method="post">
                    <?php if(!isset($_GET['tourtype_code'])):?>
