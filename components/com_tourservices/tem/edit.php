...
<div class="container">
    <div class="frm-control">
		<div class="link-header">
            <h3><span class="color-1"><?php echo $tour_name;?></span> > Cập nhật dịch vụ Tour</h3>
        </div>
       <div class="box-step">
            <ul>
				<li>
		...
		<div class="row">
			<div class="col-md-6">
				...
				<a href="<?php echo ROOTHOST.'member/tour/'.$tour_code.'/cap-nhat-lien-he'?>" class="save btn-default btn-success">Continues</a>
			</form>
