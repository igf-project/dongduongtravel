...
<?php
    ...
    if(isset($_POST['cmdsave'])){
		...
		if(isset($_POST['txtid'])){
			...
			echo "<script language=\"javascript\">window.location.href='".ROOTHOST."member/tour/".$obj->Code."/cap-nhat-lich-trinh'</script>";   
		}else{
			$obj->Add_new();
			echo "<script language=\"javascript\">window.location.href='".ROOTHOST."member/tour/".$obj->Code."/them-lich-trinh'</script>";   
		}
	}
