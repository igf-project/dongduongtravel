...
<div class="container">
    <div class="frm-control">
        <div class="link-header">
            <h3><span class="color-1"><?php echo $tour_name;?></span>> Cập nhật lịch trình</h3>
        </div>
        <div class="box-step">
            <ul>
                <li>
    ...
    <!--
        ...
        if($day_active < $tour_num_day) $url=ROOTHOST."member/tour/".$tour_code."/cap-nhat-lich-trinh/ngay-".$day_next."";
        else $url=ROOTHOST."member/tour/".$tour_code."/cap-nhat-thu-vien-anh";
        ?>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <form id="frm-tour-where" name="frm-tour-where" method="post" action="<?php echo ROOTHOST;?>ajaxs/action_add_tourprogram/tour_where/action.php"  enctype="multipart/form-data">
                            ...
                            <span class="btn btn-success" onclick="addObj('where')">Addnew</span>
                        </form>
                    </div>
                    <div class="col-md-6">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <form id="frm-tour-food" name="frm-tour-food" method="post" action="<?php echo ROOTHOST;?>ajaxs/action_add_tourprogram/tour_food/action.php" enctype="multipart/form-data">
                            ...
                            <span class="btn btn-success" onclick="addObj('food')">Addnew</span>
                        </form>
                    </div>
                ...
                <div class="row">
                    <div class='col-md-6'>
                        <form id="frm-tour-sleep" name="frm-tour-sleep" method="post" action="<?php echo ROOTHOST;?>ajaxs/action_add_tourprogram/tour_sleep/action.php" enctype="multipart/form-data">
                            ...
                            <span class="btn btn-success" onclick="addObj('sleep')">Addnew</span>
                        </form>
                    </div>
                    <div class="col-md-6">
...
$(document).ready(function() {
   /* *//* add where*//*
    $('#add-where').click(function(){
        ...
        var url=form.attr('action');
        $.post(url, postData, function(response_data){
            $('#respon-where').html(response_data);form.reset();
        });
