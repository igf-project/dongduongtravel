...
class CLS_GALLERY{
    ...
    public function Delete($id,$strwhere=''){
        $sql="DELETE FROM `tbl_gallery` WHERE `id` = $id $strwhere";
        // echo $sql;
        return $this->objmysql->Exec($sql);
    }
        ...
        while($rows=$objdata->Fetch_Assoc()){
            ...
            foreach($arr as $list):?>
                <div class="info-item">
                    ...
                    <span class="del-item" data-id='<?php echo $rows['id'] ?>' value="<?php echo $list;?>" onclick="del_itemGallery(this)"></span>
                </div>
           <?php endforeach;
        }
    }
