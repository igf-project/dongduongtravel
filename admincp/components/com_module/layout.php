<?php
	...
	include_once(libs_path.'cls.product.php');
	include_once(libs_path.'cls.albumgallery.php');
	...
	if(isset($_POST['cmdsave'])){
		...
		if(isset($_POST['cbo_cata'])) 		$obj->Cata_ID=(int)$_POST['cbo_cata'];
		if(isset($_POST['cbo_album'])) 		$obj->Album=(int)$_POST['cbo_album'];
