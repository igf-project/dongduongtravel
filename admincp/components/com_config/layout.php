...
<div id='action'>
    ...
    <form name="frm_action" id="frm_action" action="" method="post">
        <div class="row">
            ...
            <div class="form-group">
                <label for="" class="col-sm-3 form-control-label">Tên công ty</label>
                <div class="col-sm-9">
            ...
            <div class="form-group">
                <label for="" class="col-sm-3 form-control-label">Di động</label>
                <div class="col-sm-9">
            ...
            <div class="form-group">
                <label for="" class="col-sm-3 form-control-label">Fax</label>
                <div class="col-sm-9">
