...
define('OBJ_PAGE','POSITION_FOOD');
define('TASK_NAME', ' Danh sách thực đơn');
write_path();
    ...
    <div id="list">
        ...
        <form id="frm_list" name="frm_list" method="post" action="">
            <table width="100%" border="0" cellspacing="0" cellpadding="0" class="Header_list">
                <tr>
                    ...
                    <td align="right">
                        <a href="?com=position&task=add_cultural&pos=<?php echo $position_id; ?>" class="btn btn-success button"><i class="fa fa-plus" aria-hidden="true"></i> Thêm mới</a>
                    </td>
                </tr>
            </table>
            ...
            <table class="table table-bordered">
                ...
                while($rows=$objdata->Fetch_Assoc()){
                    ...
                    echo "<a href='index.php?com=".COMS."&amp;task=active_cultural&amp;id=$ids&pos=$position_id'>";
                    showIconFun('publish',$rows["isactive"]);
                    echo "</a>";
                    echo "</td>";

                    echo "<td  align='center'>";
                    echo "<a href='index.php?com=".COMS."&amp;task=edit_cultural&amp;id=$ids&pos=$position_id'>";
                    showIconFun('edit','');
                    echo "</a>";
                    echo "</td>";

                    echo "<td align='center'>";
                    echo "<a href='index.php?com=".COMS."&amp;task=delete_cultural&amp;id=$ids&pos=$position_id' onclick=\"return confirm('Bạn có chắc muốn xóa !')\">";
                    showIconFun('delete','');
                    echo "</a>";
                    echo "</td>";
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0" class="Footer_list">
            <tr>
                <td align="center">
                    <?php
                    paging($total_rows,MAX_ROWS,$cur_page,'?com=position&task=list-vanhoa&page={page}');
                    ?>
                </td>
            </tr>
        </table>
