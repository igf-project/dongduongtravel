        ...
        <div class="box-tabs">
            <form id="frm_action" name="frm_action" method="post" action="" enctype="multipart/form-data">
                ...
                <div class="box-control">
                    <a href="?com=position&task=list-lichsu$pos=<?php echo $location_id ?>" class="btn btn-default pull-left">Quay lại</a>
                ...
                <div class="tab-content">
                    ...
                    <div class="text-center">
                        <br/>
                        <a href="?com=position&task=list-lichsu$pos=<?php echo $location_id ?>" class="btn btn-default">Quay lại</a>
