...
// Pagging
$sql="SELECT count(*)  as num FROM `tbl_catalog` WHERE 1=1 ".$strwhere;
$objdata->Query($sql);
    ...
    <form id="frm_list" name="frm_list" method="post" action="">
        <table width="100%" border="0" cellspacing="0" cellpadding="0" class="Header_list">
            <tr>
                ...
                <td align="right">
                    <a href="?com=catalogs&task=add" class="btn btn-success button"><i class="fa fa-plus" aria-hidden="true"></i> Thêm mới</a>
                </td>
            </tr>
        </table>
        ...
        <table class="table table-bordered">
            ...
            $leng=MAX_ROWS;
            $sql="SELECT * FROM tbl_catalog WHERE 1=1 $strwhere ORDER BY `cat_id` DESC LIMIT $start,$leng";
