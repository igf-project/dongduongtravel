...
if(isset($_POST['cmdsave'])){
    ...
    $sql="UPDATE tbl_location_content_festival SET 
    ...
    echo "<script>window.location.href='index.php?com=".COMS."&task=list-lehoi&loc=".$location_id."'</script>";
}
...
if($location_id!=''){
    ...
    define('TASK_NAME', 'Sửa bài viết lễ hội cho <font color="red">'.$r["name"].'</font>');
    write_path();

    $sql="SELECT * FROM tbl_location_content_festival WHERE id= $ID ";
    $objdata->Query($sql);
    $row=$objdata->Fetch_Assoc();

    ?>
    <h1 align='center'>Sửa bài viết lễ hội <font color="red"><?php echo $r["name"] ?></font></h1><hr/>
    <div id="action">
        <div class="box-tabs">
            <form id="frm_action" name="frm_action" method="post" action="" enctype="multipart/form-data">
                <input type="hidden" name="txt_location_id" value="<?php echo $location_id; ?>">
                <div class="box-control">
                    <a href="?com=location&task=list-lehoi&loc=<?php echo $location_id ?>" class="btn btn-default pull-left">Quay lại</a>
                ...
                <div class="tab-content">
                    ...
                    <div class="text-center">
                        <br/>
                        <a href="?com=location&task=list-lehoi&loc=<?php echo $location_id ?>" class="btn btn-default">Quay lại</a>
