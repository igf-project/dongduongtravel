...
define('OBJ_PAGE','LOCATION_HISTORY');
    ...
    <div id="list">
        ...
        <form id="frm_list" name="frm_list" method="post" action="">
            <table width="100%" border="0" cellspacing="0" cellpadding="0" class="Header_list">
                <tr>
                    ...
                    <td align="right">
                        <a href="?com=location&task=add_history&loc=<?php echo $location_id; ?>" class="btn btn-success button"><i class="fa fa-plus" aria-hidden="true"></i> Thêm mới</a>
                    </td>
                </tr>
            </table>
            ...
            <table class="table table-bordered">
                ...
                while($rows=$objdata->Fetch_Assoc()){
                    ...
                    echo "<a href='index.php?com=".COMS."&amp;task=active_history&amp;id=$ids&loc=$location_id'>";
                    showIconFun('publish',$rows["isactive"]);
                    echo "</a>";
                    echo "</td>";

                    echo "<td  align='center'>";
                    echo "<a href='index.php?com=".COMS."&amp;task=edit_history&amp;id=$ids&loc=$location_id'>";
                    showIconFun('edit','');
                    echo "</a>";
                    echo "</td>";

                    echo "<td align='center'>";
                    echo "<a href='index.php?com=".COMS."&amp;task=delete_history&amp;id=$ids&loc=$location_id' onclick=\"return confirm('Bạn có chắc muốn xóa !')\">";
                    showIconFun('delete','');
                    echo "</a>";
                    echo "</td>";
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0" class="Footer_list">
            <tr>
                <td align="center">
                    <?php
                    paging($total_rows,MAX_ROWS,$cur_page,'?com=location&task=list-lichsu&page={page}');
                    ?>
                </td>
            </tr>
        </table>
