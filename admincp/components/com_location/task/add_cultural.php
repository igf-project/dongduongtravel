...
if(isset($_POST['cmdsave'])){
    ...
    $sql="INSERT INTO tbl_location_content_cultural (`location_id`,`position_id`,`name`,`code`,`intro`,`fulltext`,`thumb`,`cdate`,`meta_title`,`meta_key`,`meta_desc`,`isactive`) VALUES ('$post_location_id' , '$post_position_id' , '$post_name' , '$post_code' , '$post_intro' , '$post_fulltext', '$post_thumb', '$date', '$post_meta_title', '$post_meta_key', '$post_meta_desc' , 1)";
    $objdata->Query($sql);
    echo "<script>window.location.href='index.php?com=".COMS."&task=list-vanhoa&loc=".$location_id."'</script>";
}
        ...
        <div class="box-tabs">
            <form id="frm_action" name="frm_action" method="post" action="" enctype="multipart/form-data">
                ...
                <div class="box-control">
                    <a href="?com=location&task=list-vanhoa&loc=<?php echo $location_id ?>" class="btn btn-default pull-left">Quay lại</a>
                ...
                <div class="tab-content">
                    ...
                    <div class="text-center">
                        <br/>
                        <a href="?com=location&task=list-vanhoa&loc=<?php echo $location_id ?>" class="btn btn-default">Quay lại</a>
