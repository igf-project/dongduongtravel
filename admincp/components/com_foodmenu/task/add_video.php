    ...
    <div class="frm-control">
        ...
        <div class="box-form">
            ...
            <div class="box-btn-act top30">
                <a href="<?php echo ROOTHOST."member/thuc-don/".$food_code."/them-bai-viet-lien-quan/".$position_id."/".$positioncontact_id."/".$food_id;?>" class="save-continues btn-default btn-primary">Lưu và tiếp tục</a>
            </div>
