...
// Pagging
$sql="SELECT count(*)  as num FROM `tbl_foodmenu_category` WHERE 1=1 ".$strwhere;
$objdata->Query($sql);
...
<div id="list">
    <form id="frm_list" name="frm_list" method="post" action="">
        <table width="100%" border="0" cellspacing="0" cellpadding="0" class="Header_list">
            <tr>
                ...
                <td align="right">
                    <a href="?com=foodmenucate&task=add" class="btn btn-success button"><i class="fa fa-plus" aria-hidden="true"></i> Thêm mới</a>
                </td>
            </tr>
        </table>
        ...
        <table class="table table-bordered">
            ...
            $leng=MAX_ROWS;
            $sql="SELECT * FROM tbl_foodmenu_category WHERE 1=1 $strwhere LIMIT $start,$leng";
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0" class="Footer_list">
        <tr>
            <td align="center">
                <?php 
                paging($total_rows,MAX_ROWS,$cur_page,'?com=foodmenucate&page={page}');
                ?>
            </td>
        </tr>
    </table>
