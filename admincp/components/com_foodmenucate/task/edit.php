...
if(isset($_POST["cmdsave"])){        
    ...
    $sql="UPDATE tbl_foodmenu_category SET `name`='$post_name', `code`='$post_code', `intro`='$post_intro' WHERE id=$ID ";
    $objdata->Query($sql);
    echo "<script language=\"javascript\">window.location='index.php?com=".COMS."'</script>";
}

$sql="SELECT * FROM tbl_foodmenu_category WHERE isactive=1 AND id=$ID";
$objdata->Query($sql);
$row = $objdata->Fetch_Assoc();
?>
<h1 align='center'>Sửa nhóm ẩm thực </h1><hr/>
<div id="action">
    <div class="box-tabs">
        <form id="frm_action" name="frm_action" method="post" action="" enctype="multipart/form-data">
            ...
            <div class="text-center">
                <br/>
                <a href="?com=foodmenucate" class="btn btn-default">Quay lại</a>
