...
<div class="container">
    <div class="frm-control">
       <h3><span class="color-1"><?php echo $tour_name;?></span> > Cập nhật thư viện ảnh</h3>
        ...
        <div id="action" class="box-form">
            ...
            <a href="<?php echo ROOTHOST;?>member/tour/danh-sach" class="btn-finish btn btn-primary">Hoàn thành</a>
            <div id="respon-img">
