...
class CLS_POSITIONVIDEO{
    ...
    public function Add_new(){
        $sql=" INSERT INTO `tbl_position_video`(`positioncontact_id`, `arr_videoid`, `isactive`, `order`) VALUES";
        $sql.="('".$this->positionContactId."', '".$this->arrVideoId."', '".$this->isActive."', '".$this->Order."')";

        return $this->objmysql->Exec($sql);
    }
    public function Update(){
        $sql = "UPDATE tbl_position_video SET `arr_videoid`=".$this->arrVideoId." WHERE `positioncontact_id`='".$this->positionContactId."'";
        return $this->objmysql->Exec($sql);
    }
    public function Delete($id){
        $sql="DELETE FROM `tbl_position_video` WHERE `positioncontact_id` in ('$id')";
        return $this->objmysql->Exec($sql);
    }
