        ...
        <div class="box-category">
            <div class="item">
                ...
                <ul class="content info-detail">
                    ...
                    <li><a href="<?php echo ROOTHOST."tour";?>" title="">Tour</a></li>
                    <li><a href="<?php echo ROOTHOST."qua-tang";?>">Qùa tặng</a></li>
                    <li><a href="<?php echo ROOTHOST."di-dau";?>">Khám phá địa danh</a></li>
                    <li><a href="<?php echo ROOTHOST."ngu-nghi";?>">Khách sạn</a></li>
                    <li><a href="<?php echo ROOTHOST."an-uong";?>">Ăn uống</a></li>
                </ul>
            </div>
