...
<script language="javascript">
	 ...
	 function submitUpdate(){
		...
		var url ='<?php echo ROOTHOST;?>ajaxs/action_add_tourprogram/action.php';
	...
	$('.actEdit').click(function(){
		...
		$.get('<?php echo ROOTHOST;?>ajaxs/action_add_tourprogram/actionFormEdit.php',{val, tour_id},function(response_data){
			$('#myModal').modal('show');
	...
	$('.actAjax').click(function(){
		...
		$.post('<?php echo ROOTHOST;?>ajaxs/action_add_tourprogram/comAction.php',data,function(response_data){
